...
#project(
  ...
  En este modo de operación sólo uno de los motores es empleado para cargar el compresor, la idea es que sea un modo de operación de alta eficiencia y baja presión. Entonces se automatiza este motor para que cada vez que la presión caiga por debajo de cierto límite, el mismo se enciende, y luego de que se llega a cierto límite el motor se apaga.

  ///home/tomii/Descargas/PLC_LogixPro 1.6 Full.iso hay que hacer el diagrama de escalera y además otro con explicaciones de qué es cada cosa

  = Modo de operación B

  En este modo se emplean los dos motores en vez de uno solo, es lo mismo que antes pero con los dos motores, la idea es que sea un modo de alta presión y performance.

  = Modo de operación C

  Y este modo es un balance entre los dos anteriores, para un cierto bajo nivel de presión se activan los dos motores, haciendo que la presión eleve rápidamente y luego llegado cierto nivel de presión solo se activa uno de los motores para completar el nivel de presión deseado, luego se apaga el motor.
